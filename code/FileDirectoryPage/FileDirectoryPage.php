...
class FileDirectoryPage extends Page
{
	...
	private static $has_one = [
		'CustomIcon' => Assets\Image::class
	];
	
	private static $many_many = [
		'Files' => Assets\File::class
	];
	...
	public function getCMSFields()
	{
		...
		$uploadDirectory = Assets\Folder::find_or_make($this->Config()->get('upload_directory'));
		...
		$gfConfig->getComponentByType(Forms\GridField\GridFieldAddExistingAutocompleter::class)
			->setSearchList(Assets\File::get()->filter('ParentID',$uploadDirectory->ID));
